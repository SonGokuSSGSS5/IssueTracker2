...
<nav class="site-header sticky-top py-1">
  <div class="container d-flex flex-column flex-md-row justify-content-between">
    ...
    <a class="py-2 d-none d-md-inline-block" href="RaiseIssue?uid=${user.userid }">Raise Issue</a>
    <a class="py-2 d-none d-md-inline-block" href="ViewIssueHistory?uid=${user.userid }">View Issue History</a>
